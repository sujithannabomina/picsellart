...
// ✅ Admin panel for managing seller payouts
...
// ✅ IMPORTANT: Only these emails can access admin
const ADMIN_EMAILS = [
  "jithbomina@gmail.com", // Your email
  ...
  const markAsPaid = async (sale) => {
    ...
    try {
      ...
      await updateDoc(sellerRef, {
        pendingEarnings: sale.sellerEarning * -1, // Subtract from pending
      });
